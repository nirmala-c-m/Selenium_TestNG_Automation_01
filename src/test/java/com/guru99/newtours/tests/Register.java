...
public class Register {
	...
	public void reg_contactInfo(String fName, String lName, String phonenumber, String email) {
		...
		extentTest.log(Status.INFO, "Entered contact info");
		extentTest.log(Status.PASS, "Contact info added Successfully");
	}
	...
	public void reg_mailingInfo(String address, String city, String state, String postalCode) {
		...
		extentTest.log(Status.INFO, "Entered Mailing info");
		extentTest.log(Status.PASS, "Mailing info added Successfully");
	...
	public void reg_userInfo(String username, String password, String confirmpassword) {
		...
		extentTest.log(Status.INFO, "Entered Register info");
		extentTest.log(Status.PASS, "Register info added Successfully");
	...
	public void submit() {
		...
		extentTest.log(Status.INFO, "Registration Submitted");
		extentTest.log(Status.PASS, "Registration completed Successfully");
	}

	public void verifyRegistration() {
		boolean isRegistered = wait.until(
				ExpectedConditions.textToBePresentInElementLocated(By.tagName("body"), "Thank you for registering"));
